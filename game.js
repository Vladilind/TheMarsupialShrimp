...
async function preloadGameAudio(){if(!audioManager.audioInitialized){await audioManager.initAudio();}if(!audioManager.audioInitialized){return;}await audioManager.loadSound('musicReef','sounds/music_reef.ogg',!0);await audioManager.loadSound('musicKelp','sounds/music_kelp.ogg',!0);await audioManager.loadSound('musicOcean','sounds/music_ocean.ogg',!0);await audioManager.loadSound('sfxCollect','sounds/sfx_collect.wav',!1);await audioManager.loadSound('sfxPlayerHurt','sounds/sfx_player_hurt.wav',!1);await audioManager.loadSound('sfxEnemyHit','sounds/sfx_enemy_hit.wav',!1);await audioManager.loadSound('sfxEnemyDestroy','sounds/sfx_enemy_destroy.wav',!1);/* await audioManager.loadSound('sfxSealCharge', 'sounds/sfx_seal_charge.wav', false); */ console.log("Audio preloading attempted.");}
